...
function RootPage() {
  ...
  useEffect(() => {
    tf.loadGraphModel(
      `/model/${modelName.name}/${modelName.child[1]}/model.json`,
      {
    ...
    <>
      ...
      >
        <Stack align="center" textAlign="center" spacing={4} mb={10} maxW={640}>
          ...
          <Text>
            This object detection project uses the YOLOv5 model which has been
            converted to Tensorflow.js format for edge computing.
          </Text>
        </Stack>
        ...
        >
          <GridItem
            as={Button}
            disabled={singleImage || liveWebcam}
